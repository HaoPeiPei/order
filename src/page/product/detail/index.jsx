...
class Detail extends React.Component{
    ...
    componentDidMount(){
        //加载商品品类
        this.props.getProductDetailData(this.props.productDetailId);
    }
    ...
    render(){
        ...
        return (
            <Modal {...this.props} className="deatal_common">
                ...
                <div className="datail_right">
                    <div className="info_top">
                        ...
                        <p><span className="goodsNo">款号：{ productDetail['goodsNo'] } </span><span>类别：{ productDetail.category }</span></p>
